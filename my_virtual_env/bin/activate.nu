...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/christos/proyectos/lambda_functions/venv_prueba/my_virtual_env'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/christos/proyectos/lambda_functions/venv_prueba/my_virtual_env/bin/deactivate.nu'
